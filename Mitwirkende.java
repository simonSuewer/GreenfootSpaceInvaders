...
public class Mitwirkende extends World
{
    ...
    private static GreenfootSound soundThugLife = new GreenfootSound("thuglife.wav"); 
    
    
    public void started() {
        soundThugLife.playLoop();
    }
