...
/**
 * Write a description of class AiMax here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class AiMax extends AiEnemy
{
    ...
    public void act() 
    {
       //shot
        ...
        if((Greenfoot.getRandomNumber(100) < 2) && (getWorld().getObjects(EnemyRocket.class).size())< 3)
        {
